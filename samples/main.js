...
function preprocess(shaderTextIn) {
    ...
    console.log('input len: ' + shaderTextIn.length
        + ' outptut len: ' + shaderTextOut.length
        + ' saved len: ' + (shaderTextIn.length - shaderTextOut.length)
    );
